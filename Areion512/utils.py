...
class MITMPreConstraints:
    ...
    @staticmethod
    def Match_direct(var1, var2, m):
        c = []
        c = c + [var1[0] + ' + ' + var1[1] + ' - ' + m + ' >= 0']
        c = c + [var2[0] + ' + ' + var2[1] + ' - ' + m + ' >= 0']
        c = c + [var1[1] + ' + ' + var2[0] + ' - ' + var2[1] + ' - ' + m + ' <= 1']
        c = c + [var1[1] + ' - ' + var2[0] + ' + ' + var2[1] + ' - ' + m + ' <= 1']
        c = c + [var1[0] + ' - ' + var1[1] + ' + ' + var2[1] + ' - ' + m + ' <= 1']
        c = c + [var1[0] + ' + ' + var2[0] + ' - ' + var2[1] + ' - ' + m + ' <= 1']
        c = c + [var1[0] + ' + ' + var1[1] + ' + ' + var2[0] + ' + ' + var2[1] + ' + ' + m + ' <= 4']
        c = c + [var1[1] + ' + ' + var2[1] + ' - ' + var1[0] + ' - ' + m + ' <= 1']
        return c
