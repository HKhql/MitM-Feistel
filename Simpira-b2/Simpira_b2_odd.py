...
class Constraints_generator:
    ...
    def genConstraints_link_round(self):
        ...
        for r in range(self.TR):
            ...
            if r != self.mat_r:
                if r == self.TR - 1:
                    cons = cons + MITMPreConstraints.equalConstraints(OP_L_1, IP_next_r_R_1)
                    cons = cons + MITMPreConstraints.equalConstraints(OP_L_2, IP_next_r_R_2)
                    cons = cons + MITMPreConstraints.equalConstraints(OP_R_1, IP_next_r_L_1)
                    cons = cons + MITMPreConstraints.equalConstraints(OP_R_2, IP_next_r_L_2)
                else:
    ...
    def genConstraints_additional(self):
        ...
        # cons = cons + [BasicTools.plusTerms(Match_Blue_Counter + Match_Red_Counter) + ' <= 3']
        return cons
